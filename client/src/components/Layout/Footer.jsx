    ...
    <footer className="footer">
      <div className="footer-grid">
        ...
        <div className="footer-section company-info">
          <h3>من نحن؟</h3>
          <p>
          نحن في نطاق الدعم نؤمن بأن الحلول الذكية والبسيطة هي المفتاح لراحة العملاء في كل ما يتعلق بصيانة وإصلاح السيارات.
          </p> <br /> 
          <p>
          منصتنا تجمع بين أصحاب السيارات وأفضل ورش الصيانة المتخصصة لتقديم عروض شفافة وعادلة. 
          </p> <br />
          <p>
          نسعى لتوفير تجربة مميزة تساعد المستخدمين على حل مشاكل سياراتهم بسرعة وسهولة، وذلك من خلال تقديم الدعم الكامل من لحظة الإبلاغ عن المشكلة وحتى اختيار العرض الأنسب.
          </p> <br />
          <p>
          نطمح إلى بناء مجتمع من الثقة والكفاءة، حيث يحصل الجميع على أفضل الخدمات بأسلوب احترافي
          </p>
        </div>
